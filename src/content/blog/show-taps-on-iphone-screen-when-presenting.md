...
Fortunately, [iOS 14 added a handy feature](https://support.apple.com/en-us/HT211008) that makes it easier to highlight exactly where someone needs to tap thanks to the Accessibility features that were added and Apple's extended support for mice in iPadOS. In this article, we'll walk through how you can show taps when sharing an iPhone screen during a demo using these [Accessibility features](https://support.apple.com/en-us/HT210546).
...
![Configuring settings to enable AssistiveTouch on iOS.](/images/blog/2022-01-01-16-36-29-1.gif)
...
![Setting on iOS to pair to a new mouse.](/images/blog/2022-01-01-18-12-43-1.gif)

![Showing how you can see the cursor on an iOS screen when AssistiveTouch is enabled.](/images/blog/2022-01-01-18-28-43-1.gif)
...
Do you find this will help up your demo game? Also check out my recent article on how you can [add live cartoons to your livestreams](/blog/add-live-cartoons-to-your-livestream-with-adobe-character-animator-with-obs/) using Adobe Character Animator and OBS.
