...
![Focus Mode settings in iOS Settings.](/images/blog/Screenshot-2022-01-09-16-24-36-1024x576.png)

1. On your device, go to **Settings** > **Focus**.
2. Tap the **+** symbol.
3. Tap **Custom**.
4. Set the name of your focus mode — for example, "Demo".
5. Set your color and icon.
6. Tap **Next**.

![Setting the name of your Focus mode, the color, and the icon in iOS Settings.](/images/blog/Screenshot-2022-01-09-16-25-08-1024x576.png)

### Set Allowed People for Notifications

![Focus mode in iOS allows you to set which people you want to receive notifications from.](/images/blog/Screenshot-2022-01-09-16-25-28-1024x576.png)
...
![Focus Mode in iOS allows you to set which apps you will get notifications from.](/images/blog/Screenshot-2022-01-09-16-25-59-1024x576.png)
...
![Focus mode in iOS showing that the Focus mode has been configured.](/images/blog/Screenshot-2022-01-09-16-26-07-1024x576.png)

### Set a Custom Home Screen

![Focus mode settings in iOS Settings allowing you to choose which Home Screens are visible.](/images/blog/Screenshot-2022-01-09-16-26-13-1-1024x576.png)
...
1. When editing your Focus mode, tap **Home Screen**.
2. Enable **Custom Pages**.
3. Choose which Home Screen(s) you want enabled.
4. Tap **Done**.

![Focus Mode allows you to choose which Home Screens are available, removing unwanted apps from view.](/images/blog/Screenshot-2022-01-09-16-27-10-1024x576.png)

### How to enable your new Focus mode

Whenever you need to start a demo, enabling your Focus mode takes just a few seconds:

1. Open Control Center (on iPhone X or later, swipe down from the top-right corner).
